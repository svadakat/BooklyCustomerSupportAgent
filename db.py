...
_CUSTOMERS = [
    # original 5
    ("C001", "Sarah Mitchell",    "sarah.mitchell@email.com",   "415-555-0101", "2023-04-12"),
    ("C002", "James Rodriguez",   "james.r@gmail.com",          "212-555-0182", "2022-11-03"),
    ("C003", "Emily Chen",        "emily.chen@bookworm.com",    "650-555-0247", "2021-06-18"),
    ("C004", "Michael Thompson",  "mthompson@work.com",         "312-555-0334", "2024-01-09"),
    ("C005", "Priya Sharma",      "priya.s@outlook.com",        "408-555-0456", "2023-09-22"),
    # 10 new customers
    ("C006", "David Kim",         "david.kim@techie.com",       "310-555-0612", "2022-03-15"),
    ("C007", "Rachel Green",      "rachel.g@hotmail.com",       "617-555-0771", "2023-07-04"),
    ("C008", "Omar Hassan",       "omar.hassan@gmail.com",      "713-555-0885", "2024-02-28"),
    ("C009", "Lisa Nguyen",       "lisa.nguyen@yahoo.com",      "503-555-0934", "2021-12-01"),
    ("C010", "Tom Bradley",       "t.bradley@company.com",      "202-555-1023", "2023-11-19"),
    ("C011", "Aisha Patel",       "aisha.patel@gmail.com",      "404-555-1145", "2022-08-30"),
    ("C012", "Carlos Rivera",     "c.rivera@outlook.com",       "305-555-1267", "2024-03-01"),
    ("C013", "Jennifer Wu",       "jen.wu@stanford.edu",        "650-555-1389", "2020-09-01"),
    ("C014", "Robert Davis",      "rdavis@enterprise.com",      "214-555-1401", "2023-05-17"),
    ("C015", "Natasha Ivanova",   "n.ivanova@gmail.com",        "206-555-1512", "2022-06-11"),
]

_ORDERS = [
    # (order_id, customer_id, book_title, book_author, qty, total, status, carrier, tracking, order_date, delivery_estimate)

    # ── Original 10 ──────────────────────────────────────────────────────────
    ("B1001", "C001", "The Covenant of Water",                    "Abraham Verghese",                   1, 27.99, "Shipped",           "UPS",   "1Z999AA10191226791",   "2026-03-01", "2026-03-09"),
    ("B1002", "C002", "Zero to One + Sapiens (bundle)",           "Peter Thiel / Yuval Noah Harari",    2, 45.98, "Processing",        None,    None,                   "2026-03-05", "2026-03-12"),
    ("B1003", "C003", "Thinking, Fast and Slow",                  "Daniel Kahneman",                    1, 18.99, "Delivered",         "FedEx", "449044304137821",      "2026-02-13", "2026-02-20"),
    ("B1004", "C004", "Meditations",                              "Marcus Aurelius",                    1, 14.99, "Out for Delivery",   "USPS",  "9400111899223397591",  "2026-03-04", "2026-03-07"),
    ("B1005", "C005", "Superintelligence",                        "Nick Bostrom",                       1, 24.99, "Shipped",           "FedEx", "788899820820",         "2026-03-03", "2026-03-10"),
    ("B1006", "C001", "The Beginning of Infinity",                "David Deutsch",                      1, 21.99, "Processing",        None,    None,                   "2026-03-06", "2026-03-13"),
    ("B1007", "C002", "Man's Search for Meaning",                 "Viktor Frankl",                      1, 13.99, "Delivered",         "UPS",   "1Z999AA10191226792",   "2026-02-08", "2026-02-15"),
    ("B1008", "C003", "Brave New World",                          "Aldous Huxley",                      1, 11.99, "Shipped",           "USPS",  "9400111899223397592",  "2026-03-02", "2026-03-09"),
    ("B1009", "C004", "Blitzscaling",                             "Reid Hoffman & Chris Yeh",           1, 29.99, "Delivered",         "FedEx", "449044304137822",      "2026-02-23", "2026-03-01"),
    ("B1010", "C005", "Sapiens",                                  "Yuval Noah Harari",                  1, 19.99, "Delivered",         "UPS",   "1Z999AA10191226793",   "2026-02-18", "2026-02-25"),

    # ── 20 new orders ────────────────────────────────────────────────────────
    ("B1011", "C006", "Zero to One",                              "Peter Thiel & Blake Masters",        1, 22.99, "Processing",        None,    None,                   "2026-03-06", "2026-03-13"),
    ("B1012", "C007", "Sapiens",                                  "Yuval Noah Harari",                  1, 19.99, "Shipped",           "UPS",   "1Z999AA10191226794",   "2026-03-02", "2026-03-09"),
    ("B1013", "C008", "Man's Search for Meaning + Meditations",   "Viktor Frankl / Marcus Aurelius",    2, 28.98, "Delivered",         "FedEx", "449044304137823",      "2026-02-10", "2026-02-17"),
    ("B1014", "C009", "The Lean Startup",                         "Eric Ries",                          1, 23.99, "Shipped",           "FedEx", "788899820821",         "2026-03-04", "2026-03-11"),
    ("B1015", "C010", "Thinking, Fast and Slow",                  "Daniel Kahneman",                    1, 18.99, "Out for Delivery",   "USPS",  "9400111899223397593",  "2026-03-05", "2026-03-07"),
    ("B1016", "C011", "Einstein: His Life and Universe",          "Walter Isaacson",                    1, 25.99, "Processing",        None,    None,                   "2026-03-06", "2026-03-13"),
    ("B1017", "C012", "Brave New World",                          "Aldous Huxley",                      1, 11.99, "Delivered",         "UPS",   "1Z999AA10191226795",   "2026-02-20", "2026-02-27"),
    ("B1018", "C013", "The Score Takes Care of Itself",           "Bill Walsh",                         1, 21.99, "Shipped",           "FedEx", "788899820822",         "2026-03-03", "2026-03-10"),
    ("B1019", "C014", "Superintelligence + Beginning of Infinity","Nick Bostrom / David Deutsch",        2, 46.98, "Processing",        None,    None,                   "2026-03-07", "2026-03-14"),
    ("B1020", "C015", "Secrets of Sand Hill Road",                "Scott Kupor",                        1, 26.99, "Delivered",         "USPS",  "9400111899223397594",  "2026-02-14", "2026-02-21"),
    ("B1021", "C001", "Zero to One",                              "Peter Thiel & Blake Masters",        1, 22.99, "Delivered",         "FedEx", "449044304137824",      "2026-02-05", "2026-02-12"),
    ("B1022", "C002", "The Innovator's Dilemma",                  "Clayton M. Christensen",             1, 24.99, "Shipped",           "UPS",   "1Z999AA10191226796",   "2026-03-04", "2026-03-11"),
    ("B1023", "C003", "Blitzscaling",                             "Reid Hoffman & Chris Yeh",           1, 29.99, "Processing",        None,    None,                   "2026-03-07", "2026-03-14"),
    ("B1024", "C004", "Sapiens",                                  "Yuval Noah Harari",                  1, 19.99, "Delivered",         "FedEx", "449044304137825",      "2026-01-28", "2026-02-04"),
    ("B1025", "C005", "The Master Algorithm",                     "Pedro Domingos",                     1, 23.99, "Shipped",           "UPS",   "1Z999AA10191226797",   "2026-03-05", "2026-03-12"),
    ("B1026", "C006", "Brave New World",                          "Aldous Huxley",                      1, 11.99, "Delivered",         "USPS",  "9400111899223397595",  "2026-02-22", "2026-03-01"),
    ("B1027", "C007", "The Covenant of Water",                    "Abraham Verghese",                   1, 27.99, "Out for Delivery",   "FedEx", "788899820823",         "2026-03-05", "2026-03-07"),
    ("B1028", "C008", "Blitzscaling",                             "Reid Hoffman & Chris Yeh",           1, 29.99, "Processing",        None,    None,                   "2026-03-06", "2026-03-13"),
    ("B1029", "C009", "Meditations",                              "Marcus Aurelius",                    1, 14.99, "Shipped",           "UPS",   "1Z999AA10191226798",   "2026-03-03", "2026-03-10"),
    ("B1030", "C010", "The Second Machine Age",                   "Brynjolfsson & McAfee",              1, 22.99, "Delivered",         "FedEx", "449044304137826",      "2026-02-18", "2026-02-25"),
]
